        ...
        <>
            ...
            <div className="font-inter relative sm:flex sm:justify-center min-h-screen" style={{backgroundImage: 'url('+bg+')'}}>
                ...
                <div className="sm:flex sm:flex-row md:gap-20 max-w-7xl mt-16 mx-auto p-6 lg:p-8 justify-center items-center bg-cover">
                    ...
                    <div className="bg-white w-96 h-min rounded-lg drop-shadow-2xl p-11">
                        ...
                        <form onSubmit={submit} className="grid">
                            <InputError message={errors.email} className="mt-2 -mb-7" />
                            <InputLabel htmlFor="email" value="Email" className="mt-9"/>
                            <TextInput
                                id="email"
                                type="email"
                                name="email"
                            ...
                            <TextInput
                                ...
                                name="password"
                                value={data.password}
                                className="mt-1 block w-full drop-shadow-md"
