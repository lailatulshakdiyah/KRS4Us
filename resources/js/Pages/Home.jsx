                ...
                <div className="sm:flex sm:flex-row columns-2 md:gap-7 max-w-7xl min-w-full mt-16 mx-auto p-6 lg:p-8 justify-center items-start bg-cover">
                    <div className="flex flex-col gap-12 w-full">
                        <Card
                            ...
                            className="flex flex-col max-h-48 overflow-auto px-3 py-3"
                        ...
                        >
                            {list && list.map((course) => (
                                <Link href={route('course', course.id)} className="transition-all duration-200 ease-in-out hover:bg-primary-50 hover:shadow-md rounded-md px-2.5 py-1 hover:py-2"> 
