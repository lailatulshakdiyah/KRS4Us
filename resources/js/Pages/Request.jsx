        ...
        temp[i]['action'] = (
            <>
                <Link
                    ...
                    className='flex items-center justify-center py-1 w-full rounded-full bg-success-600 hover:bg-primary-400 active:bg-primary-500 text-xs text-white-300 font-normal transition-all duration-200 ease-in-out'
                >
                    Accept
                </Link>
            </>
